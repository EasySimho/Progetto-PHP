...
<body>
    <header>
        ...
        <nav>
            <a href="upload.php" class="btn" style="color:white;">Carica nuovo contenuto</a>
            <a href="logout.php" class="btn" style="background:var(--danger-color); color:white;">Logout</a>
    ...
    <main>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="delete.php?id=<?php echo $row['id']; ?>" class="action-link danger" onclick="return confirm('Sei sicuro?');">Elimina</a>
                </td>
            </tr>
            <?php endwhile; ?>
        </table>
